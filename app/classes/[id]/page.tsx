      ...
      <header className="bg-white border-b border-slate-200 px-6 py-4 shrink-0">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-4">
            <div
              className="w-12 h-12 rounded-xl flex items-center justify-center text-xl font-extrabold text-slate-700 shadow-sm"
              style={{ backgroundColor: cls.color }}
            >
              {cls.level[0]}
            </div>
            <div>
              <h1 className="text-xl font-extrabold text-slate-800 tracking-tight">{cls.name}</h1>
              <div className="flex flex-wrap items-center gap-x-3 gap-y-0.5 text-sm text-slate-500 mt-0.5">
                ...
                <span className="text-slate-300">|</span>
                <span className="font-semibold text-slate-700">{activeEnrollments.length}<span className="font-normal text-slate-400">/{cls.maxStudents}명</span></span>
                <span className="text-slate-300">|</span>
                <span className="text-blue-600 font-semibold">{cls.fee.toLocaleString()}원</span>
              </div>
            </div>
          </div>
          <button
